...
function transient_table_scripts() {
	...
	if (is_front_page() || is_page(array('find-duplicates', 'bibliography', 'sentinel', 'find-conflicts', 'errata', 'host-galaxies', 'graveyard', 'atel', 'frbs', 'mosfit')) || is_search()) {
		...
		wp_enqueue_style( 'datatables-css', "https://cdn.datatables.net/1.10.16/css/jquery.dataTables.min.css", array('parent-style'), null );
		wp_enqueue_script( 'datatables-js', "https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js", array('jquery'), null );
		wp_enqueue_style( 'datatables-ext-css', "https://cdn.datatables.net/v/dt/b-1.5.2/b-colvis-1.5.2/b-html5-1.5.2/r-2.2.2/sc-1.5.0/sl-1.2.6/datatables.min.css", array('datatables-css'), null );
		wp_enqueue_script( 'datatables-ext-js', "https://cdn.datatables.net/v/dt/b-1.5.2/b-colvis-1.5.2/b-html5-1.5.2/r-2.2.2/sc-1.5.0/sl-1.2.6/datatables.min.js", array('datatables-js'), null );
